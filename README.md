...
It probably is possible to have weights and biases that would allow such a neural network to act as an LSTM, but one look at that equation and you know things are going to explode as t->∞. (perhaps I should experiment with allowing only some neurons to have this property)
