...
Will the complete rewrite soon(in the "hivemind" folder), current code is not conducive of utilising the advantage of cache locality and simd instructions.
